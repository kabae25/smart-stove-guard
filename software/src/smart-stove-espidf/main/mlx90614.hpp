...
void MLX90614::init() { // Initialize the MLX90614
  ...
  float MLX90614::readMLX90614(uint8_t reg) {
  ...
  float MLX90614::getTemp(bool debug = true) {
  ...
  float MLX90614::buildTempReading(int num_iters = 60, bool debug = true) {
